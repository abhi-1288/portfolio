            ...
            <div className="grid md:flex justify-center md:space-x-3 space-y-3 my-4">
                ...
                <ContentFormat part="part-1">
                    <div className="grid h-fit text-xl space-y-3 font-Pacifico text-sky-500 p-2">
                        ...
                        <h1>2. <a className="underline" target="_blank" href="https://app-qr-code.vercel.app/">QR App- Full Stack</a> FullStack</h1>
                        <h1>3. <a className="underline" target="_blank" href="https://campus-connect-five-sage.vercel.app//">Campus Connect</a> FullStack</h1>
                    </div>
                </ContentFormat>
                ...
                <ContentFormat part="part-2">
                    <div className="grid h-fit text-xl space-y-3 font-Pacifico text-sky-500 p-2">
                        ...
                        <h1>3. <a className="underline" target="_blank" href="https://flowzen-azure.vercel.app">FlowZen | A Kanban App</a> FullStack</h1>
                    </div>
                </ContentFormat>
            </div>
