            ...
            <div className="grid md:flex justify-center md:space-x-3 space-y-3 my-4">
                ...
                <ContentFormat part="part-2">
                    <div className="grid h-fit text-xl space-y-3 font-Pacifico text-sky-500 p-2">
                        ...
                        <h1>2. <a className="underline" target="_blank" href="https://assignment-19-abhijeet-singh5.codeyogi-batch-2.repl.co/">Prime Number</a></h1>
                        <h1>3. <a className="underline" target="_blank" href="https://assignment-21-abhijeet-singh5.codeyogi-batch-2.repl.co/">Table Assignment</a> VIA REACT</h1>
                        <h1>4. <a className="underline" target="_blank" href="https://we-shop.netlify.app/">E-Commerse Site</a> VIA REACT</h1>
                        <h1>5. <a className="underline" target="_blank" href="https://class-based-todo.netlify.app/">TO-DO in TYPE-SCRIPT REACT </a> Class-Based COMPONENT</h1>
                        <h1>6. <a className="underline" target="_blank" href="https://resume-creater.vercel.app/">Resume Builder For Beginners </a></h1>
                        <h1>7. <a className="underline" target="_blank" href="https://todo-vanced.vercel.app/">Advanced Todo "LIKE TRELLO"  </a>Desktop site</h1>
                    </div>
                </ContentFormat>
            </div>
